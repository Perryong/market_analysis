import pandas as pd
from indicators.candle_sticks.conditions import is_downtrend, is_uptrend
from indicators.candle_sticks.single import SingleCandlePatterns
from indicators.candle_sticks.three import (
    is_evening_star,
    is_morning_star,
    is_three_black_crows,
    is_three_white_soldiers,
)
from indicators.candle_sticks.two import (
